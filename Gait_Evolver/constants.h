...
//int		EVAL_PERIOD			= 3000;
int		EVAL_PERIOD			= 1000;
...
int			NUM_EXP_GENERATIONS		= 200;
//int			NUM_EXP_GENERATIONS		= 600;

int			EXP_POPULATION_SIZE		= 15;
...
double MIN_RANGE_OF_MOTION = -70.0;
double MAX_RANGE_OF_MOTION = 70.0;
//double MIN_RANGE_OF_MOTION = -90.0;
//double MAX_RANGE_OF_MOTION = 90.0;
