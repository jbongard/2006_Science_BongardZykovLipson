...
void EE::GetSensorDataFromScreen(void) {
	...
	*/
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)<0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,-8.0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,6/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,6.2);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,5.4);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,4.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,-8.6);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)<0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,-6.8);
		dataFromTarget[simParams->currentCycle]->Set(0,13,5.1);
		dataFromTarget[simParams->currentCycle]->Set(0,14,9.5/100.0);
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)<0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,-7.6);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,19.75/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)<0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,-5.3);
		dataFromTarget[simParams->currentCycle]->Set(0,13,-8);
		dataFromTarget[simParams->currentCycle]->Set(0,14,10.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)<0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,-25.4);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,21.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)<0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,-8.3);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,6/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)<0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,-7.2);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,5.7);
		dataFromTarget[simParams->currentCycle]->Set(0,13,5.9);
		dataFromTarget[simParams->currentCycle]->Set(0,14,9/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,31.9);
		dataFromTarget[simParams->currentCycle]->Set(0,13,-1.1);
		dataFromTarget[simParams->currentCycle]->Set(0,14,19.75/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,6.3);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,6.5);
		dataFromTarget[simParams->currentCycle]->Set(0,14,6/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,5.3);
		dataFromTarget[simParams->currentCycle]->Set(0,13,-7.8);
		dataFromTarget[simParams->currentCycle]->Set(0,14,9.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,6.2);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,6.0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5.75/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,10,0);
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,6.3);
		dataFromTarget[simParams->currentCycle]->Set(0,13,0);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5.75/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,-8.7);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5.75/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,0);
		dataFromTarget[simParams->currentCycle]->Set(0,12,0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,-8.9);
		dataFromTarget[simParams->currentCycle]->Set(0,14,5.5/100.0);
	}
	...
	if ( (dataForTarget[simParams->currentCycle]->Get(EVAL_PERIOD,0)>0.0) &&
		...
		dataFromTarget[simParams->currentCycle]->Set(0,11,1);
		dataFromTarget[simParams->currentCycle]->Set(0,12,0);
		dataFromTarget[simParams->currentCycle]->Set(0,13,-26.1);
		dataFromTarget[simParams->currentCycle]->Set(0,14,17.75/100.0);
	}
