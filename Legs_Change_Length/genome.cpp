...
extern double MIN_BROKEN_LEG_SIZE;
extern double MAX_BROKEN_LEG_SIZE;
...
void GENOME::ConvertPartiallyToTarget(void) {
	...
	sticks->Set(1,1,0.177363);
	sticks->Set(2,1,0.203348);
	sticks->Set(3,1,0.208322);
	sticks->Set(4,1,0.224044);

	legChange = raw->Get(0,0);
	sticks->Set(1,2,0.95*legChange); sticks->Set(1,3,CYLINDER_DIAMETER*legChange); sticks->Set(1,4,CYLINDER_DIAMETER*legChange);
	legChange = raw->Get(0,1);
	sticks->Set(2,2,0.95*legChange); sticks->Set(2,3,CYLINDER_DIAMETER*legChange); sticks->Set(2,4,CYLINDER_DIAMETER*legChange);
	legChange = raw->Get(0,2);
	sticks->Set(3,2,0.95*legChange); sticks->Set(3,3,CYLINDER_DIAMETER*legChange); sticks->Set(3,4,CYLINDER_DIAMETER*legChange);
	legChange = raw->Get(0,3);
	sticks->Set(4,2,0.95*legChange); sticks->Set(4,3,CYLINDER_DIAMETER*legChange); sticks->Set(4,4,CYLINDER_DIAMETER*legChange);
	...
	sticks->Set(1,7,0.143*raw->Get(0,0));
	sticks->Set(2,7,0.143*raw->Get(0,1));
	sticks->Set(3,7,0.143*raw->Get(0,2));
	sticks->Set(4,7,0.143*raw->Get(0,3));
...
//	sticks->Set(8,1,0.375);
	sticks->Set(5,1,0.28876);
	sticks->Set(6,1,0.40069);
	sticks->Set(7,1,0.477269);
	sticks->Set(8,1,0.543136);

	legChange = raw->Get(0,4);
	sticks->Set(5,2,0.97*legChange); sticks->Set(5,3,CYLINDER_DIAMETER*legChange); sticks->Set(5,4,CYLINDER_DIAMETER*legChange);
	legChange = raw->Get(0,5);
	sticks->Set(6,2,0.97*legChange); sticks->Set(6,3,CYLINDER_DIAMETER*legChange); sticks->Set(6,4,CYLINDER_DIAMETER*legChange);
	legChange = raw->Get(0,6);
	sticks->Set(7,2,0.97*legChange); sticks->Set(7,3,CYLINDER_DIAMETER*legChange); sticks->Set(7,4,CYLINDER_DIAMETER*legChange);
	legChange = raw->Get(0,7);
	sticks->Set(8,2,0.97*legChange); sticks->Set(8,3,CYLINDER_DIAMETER*legChange); sticks->Set(8,4,CYLINDER_DIAMETER*legChange);
	...
	sticks->Set(5,7,0.118*raw->Get(0,4));
	sticks->Set(6,7,0.118*raw->Get(0,5));
	sticks->Set(7,7,0.118*raw->Get(0,6));
	sticks->Set(8,7,0.118*raw->Get(0,7));
}
...
void GENOME::ConvertToTarget(void) {
	...
	sticks->Set(1,7,0.143);
	sticks->Set(2,7,0.143);
	...
	sticks->Set(7,2,0.97*MIN_BROKEN_LEG_SIZE); sticks->Set(7,3,CYLINDER_DIAMETER*MIN_BROKEN_LEG_SIZE); sticks->Set(7,4,CYLINDER_DIAMETER*MIN_BROKEN_LEG_SIZE);
	...
	sticks->Set(7,7,0.118*MIN_BROKEN_LEG_SIZE);
...
void GENOME::SaveGenome(ofstream *outFile) {
...
void GENOME::CreateEstimationGenome(void) {
	...
	raw = new MATRIX(1,NUM_ANGLE_SENSORS,1.0);
...
void GENOME::PointMutation(void) {
	...
	if ( simParams->Rand(0.0,1.0) < 0.5 ) {
		...
		raw->Set(i,j,simParams->Rand(MIN_BROKEN_LEG_SIZE,MAX_BROKEN_LEG_SIZE));

	if ( raw->Get(i,j) < MIN_BROKEN_LEG_SIZE )

		raw->Set(i,j,MIN_BROKEN_LEG_SIZE);

	else if ( raw->Get(i,j) > MAX_BROKEN_LEG_SIZE )

		raw->Set(i,j,MAX_BROKEN_LEG_SIZE);
}
...
//			(*outFile) << 0.30 << " ";
//			(*outFile) << 0.40 << "\n";
			(*outFile) << 0.3814*sticks->Get(o,2) << " ";
			(*outFile) << 0.3093*sticks->Get(o,2) << " ";
			(*outFile) << 0.4124*sticks->Get(o,2) << "\n";

		double shankMass = 0.0237*sticks->Get(o,2);

		(*outFile) << "-mass " << shankMass << "\n";
