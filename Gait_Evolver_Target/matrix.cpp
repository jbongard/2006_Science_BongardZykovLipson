...
void MATRIX::Add(int i, int j, int val) {
...
void MATRIX::CopyInto(MATRIX *source) {
...
double MATRIX::MaxOfColumn(int j) {
...
double MATRIX::MinOfColumn(int j) {
...
double MATRIX::NonZeroMeanOfColumn(int j) {
