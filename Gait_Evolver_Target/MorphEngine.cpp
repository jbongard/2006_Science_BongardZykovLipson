	...
	*/
	...
	if ( ((!obj1) && (obj2->contactWithFloor) && (!obj2->fixedToWorld) ) ||
		...
		if (dCollide(o1,o2,0,&contact.geom,sizeof(dContactGeom))) {
			...
			if ( o1==env->floor ) {
				obj2->TouchingGround(contact.geom.pos);
			}

			if ( o2==env->floor ) {
				obj1->TouchingGround(contact.geom.pos);
			}
...
int main(int argc, char **argv)
{
	...
	if ( simParams->rendering ) {
		//dsSimulationLoop(argc,argv,352*2,288,&fn);
